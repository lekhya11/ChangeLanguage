...
const newWaysToConnectContent = {
  ...
  KN: {
    heading: 'ಸಂಪರ್ಕಿಸಲು ಹೊಸ ಮಾರ್ಗಗಳು',
    description:
      'Microsoft ತಂಡಗಳೊಂದಿಗೆ ನಿಮ್ಮ ಡೆಸ್ಕ್‌ಟಾಪ್‌ನಿಂದಲೇ ನೀವು ಕಾಳಜಿವಹಿಸುವ ಜನರಿಗೆ ತಕ್ಷಣ ಸಂಪರ್ಕಪಡಿಸಿ. ಅವರು ಯಾವುದೇ ಸಾಧನದಲ್ಲಿದ್ದರೂ ಉಚಿತವಾಗಿ ಕರೆ ಮಾಡಿ ಅಥವಾ ಚಾಟ್ ಮಾಡಿ.',
  },
}
...
const NewWaysToConnect = () => {
  const getNewWaysToConnectData = activeLanguage => {
    switch (activeLanguage) {
      ...
      case 'TM':
        return newWaysToConnectContent.TM
      case 'KN':
        return newWaysToConnectContent.KN
      default:
        return null
    }
  }

...
const landingSectionContent = {
  ...
  KN: {
    heading: 'ವಿಂಡೋಸ್ 11',
    description:
      'Windows 11 ತಾಜಾ ಅನುಭವದ ಮೂಲಕ ನಿಮ್ಮ ಭಾವೋದ್ರೇಕಗಳನ್ನು ಮುಂದುವರಿಸಲು ಶಾಂತ ಮತ್ತು ಸೃಜನಶೀಲ ಸ್ಥಳವನ್ನು ಒದಗಿಸುತ್ತದೆ. ಪುನರ್ಯೌವನಗೊಳಿಸಲಾದ ಪ್ರಾರಂಭ ಮೆನುವಿನಿಂದ ನಿಮ್ಮ ಮೆಚ್ಚಿನ ಜನರು, ಸುದ್ದಿ, ಆಟಗಳು ಮತ್ತು ವಿಷಯಕ್ಕೆ ಸಂಪರ್ಕಿಸಲು ಹೊಸ ಮಾರ್ಗಗಳಿಗೆ. ವಿಂಡೋಸ್ ನೈಸರ್ಗಿಕ ರೀತಿಯಲ್ಲಿ ಯೋಚಿಸಲು, ವ್ಯಕ್ತಪಡಿಸಲು ಮತ್ತು ರಚಿಸಲು ಸ್ಥಳವಾಗಿದೆ.',
  },
}
...
const LandingSection = () => {
  const getLandingSectionData = activeLanguage => {
    switch (activeLanguage) {
      ...
      case 'TM':
        return landingSectionContent.TM
      case 'KN':
        return landingSectionContent.KN
      default:
        return null
    }
  }
